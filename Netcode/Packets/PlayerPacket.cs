...
namespace Pings.Netcode.Packets
{
	public abstract class PlayerPacket : MPPacket
	{
		...
		public PlayerPacket(int whoAmI)
		{
			this.whoAmI = (byte)whoAmI;
		}

		public PlayerPacket(Player player) : this((byte)player.whoAmI)
		{
		...
		protected virtual void PostSend(BinaryWriter writer, Player player)
		{
